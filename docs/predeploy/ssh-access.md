...
Для текущего deployment workflow нужно подготовить не только SSH secrets, но и Docker Hub credentials вместе с application secrets для рендера container env-файла во время deploy.
...
Application secrets для container env-файла:
