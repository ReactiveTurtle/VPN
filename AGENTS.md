...
- `infrastructure/vpn-host/strongswan/scripts/disconnect-session.sh.template` is the current source of truth for best-effort runtime session disconnect on the VPN host.
